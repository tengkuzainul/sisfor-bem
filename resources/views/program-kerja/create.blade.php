...
@section('page-header')
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tambah Program Kerja</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Buat program kerja / kegiatan baru.</p>
    </div>
@endsection

@section('content')
    <div class="mx-auto max-w-3xl">
        <form action="{{ route('program-kerja.store') }}" method="POST" enctype="multipart/form-data" class="glass-card p-6">
            @csrf
