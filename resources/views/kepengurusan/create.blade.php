...
@section('page-header')
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tambah Kepengurusan</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Buat periode kepengurusan baru.</p>
    </div>
@endsection
