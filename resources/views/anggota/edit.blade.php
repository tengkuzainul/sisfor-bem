...
@section('breadcrumb')
    <a href="{{ route('anggota.index') }}"
        class="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">Anggota</a>
...
@section('page-header')
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Anggota</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui data anggota.</p>
    </div>
@endsection
    ...
    <div class="mx-auto max-w-3xl">
        <form action="{{ route('anggota.update', $anggota) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mt-6 flex items-center justify-end gap-3 border-t border-gray-100 pt-6 dark:border-gray-800">
                ...
                <button type="submit"
                    class="rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-primary-700">Perbarui</button>
            </div>
        </form>
    </div>
@endsection
